  ...
  return (
    <Box sx={{ padding: 3 }}>
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6} md={4}>
          <Card elevation={3} sx={{ padding: 2, textAlign: "center", borderRadius: "12px", backgroundColor: "#b0e892" }} onClick={handleAnimalsCardClick}>
            <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 1 }}>
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 2, gap: 2 }}>
          ...
          <Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
            <Button
              variant="contained"
              startIcon={<AddIcon />}
              onClick={() => router.push("/DashboardLayout/components/dashboard/AddMember")}
              sx={{
