    ...
    <Box sx={{ padding: 3 }}>
      ...
      <Dialog open={openAddEditDialog} onClose={() => setOpenAddEditDialog(false)}>
        ...
        <DialogContent>
          ...
          <TextField name="farmerId" label="Farmer ID" value={currentSystem.farmerId} onChange={handleInputChange} fullWidth margin="normal" />
        ...
        <DialogActions>
          ...
          <Button onClick={handleSubmitSystem} variant="contained" color="primary">
            Submit
          </Button>
        </DialogActions>
      </Dialog>
